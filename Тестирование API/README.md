#### В разделе "Тустирование API" рассмотрены виды API, SOAP, REST, API-документация, Swagger. Установлен Postman, рассмотрены его основные функции и создана первая коллекция автотестов. Тестирование SOAP-сервисов
